...
<head prefix="og: http://ogp.me/ns# article: http://ogp.me/ns/article#">
	...
	<meta property="og:url" content="${siteurl!}/${blog.category.url}">
	<meta property="og:title" content="${blog.title!} - ${blog.category.name!}">
	...
	<header>
		...
		<div class="blog-categories-wrapper blog-page">
			...
			<#list blog.categories as category>
				<a class="blog-category blog-page <#if category.name == blog.category.name!>active</#if>"
